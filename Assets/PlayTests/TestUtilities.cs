...
// copied across from UnityEngine.XR.Interaction.Toolkit.Tests as package not usable from our assembly
namespace UnityEngine.XR.Interaction.Toolkit.TestSupport
{
    internal static class TestUtilities
    {
        ...
        internal static XRControllerRecorder CreateControllerRecorder(XRController controller, Action<XRControllerRecording> addRecordingFrames)
        {
            ...
            // inaccessible outside xr interaction toolkit - so call through accessible ISerializationCallbackReceiver interface
            // controllerRecorder.recording.SetFrameDependentData();
            (controllerRecorder.recording as ISerializationCallbackReceiver).OnAfterDeserialize();
